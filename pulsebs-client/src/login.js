...
class LoginPage extends React.Component {
    ...
    render() {
      ...
      <AuthContext.Consumer>
          {(context)=>(
           <>
            {context.authUser && this.state.redirect ? <Redirect to={{ pathname: context.authUser.type === 0 ? '/student/lectures' : context.authUser.type === 1 ? '/teacher/courses' : '/supportOffice' }} /> : undefined}
